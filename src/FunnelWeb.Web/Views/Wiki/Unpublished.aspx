<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="FunnelWeb.Web.Application.Views.ApplicationView<FunnelWeb.Web.Controllers.WikiController.RecentModel>" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server"><h1>Unpublished Posts</h1>
      <div class="post-list"><% foreach (var entry in Model.Entries) { %>
        <div class='post-line'>
          ...
          <div class='summary'>
            <h2><%= Html.Qualify(Html.ActionLink(entry.Title, "Edit", new { page = entry.Name }))%></h2><% if (!string.IsNullOrEmpty(entry.MetaDescription)) { %>
