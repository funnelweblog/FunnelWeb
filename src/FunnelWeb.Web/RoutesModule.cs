...
namespace FunnelWeb.Web
{
    public class RoutesModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            // Login
            routes.MapLowerCaseRoute("login/{action}", new { controller = "Login", action = "Login", databaseIssue = UrlParameter.Optional, ReturnUrl = UrlParameter.Optional });
            ...
            routes.MapLowerCaseRoute("unpublished", new { controller = "Wiki", action = "Unpublished" });
            routes.MapLowerCaseRoute("search", new { controller = "Wiki", action = "Search" });
            routes.MapLowerCaseRoute("new", new { controller = "Wiki", action = "Edit", page = "" });
            routes.MapLowerCaseRoute("edit/{*page}", new { controller = "Wiki", action = "Edit", page = UrlParameter.Optional });
            routes.MapLowerCaseRoute("revert/{*page}", new { controller = "Wiki", action = "Revert" });
